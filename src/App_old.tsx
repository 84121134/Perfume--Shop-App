...
const STORIES = [
  { id: 1, label: 'Novidades', img: 'https://www.instagram.com/reel/DchukDrAWoR/?utm_source=ig_web_copy_link&igsi=MzRlODBiNWFlZA==' },
  { id: 2, label: 'Femininos', img: '' },
  ...
  { id: 5, label: 'Ofertas', img: 'https://images.unsplash.com/photo-1571990306521-cf96e6858f2a?w=120&h=120&fit=crop&auto=format' },
]
...
const PRODUCTS = [
  {
    ...
    brand: 'Lancôme',
    price: 'R$ 29,90',
    img: 'https://kommodo.ai/i/kZj3YpqPoBmPjagGsSZg/image.png',
    tag: 'Mais Vendido',
    liked: false,
  },
  {
    ...
    brand: 'Dior',
    price: 'R$ 520,00',
    img: 'https://images.unsplash.com/photo-1615160460366-2c9a41771b51?w=400&h=400&fit=crop&auto=format',
    tag: 'Lançamento',
    liked: false,
  },
  {
    ...
    brand: 'Chanel',
    price: 'R$ 610,00',
    img: 'https://images.unsplash.com/photo-1543422655-ac1c6ca993ed?w=400&h=400&fit=crop&auto=format',
    tag: '',
    liked: false,
  },
  {
    ...
    brand: 'Chanel',
    price: 'R$ 695,00',
    img: 'https://images.unsplash.com/photo-1606391484561-e1831bf6a8a0?w=400&h=400&fit=crop&auto=format',
    tag: 'Exclusivo',
    liked: false,
  },
  {
    ...
    price: 'R$ 450,00',
    img: 'https://images.unsplash.com/photo-1638295916768-459f6cf440bc?w=400&h=400&fit=crop&auto=format',
    tag: '',
    liked: false,
  },
  {
    id: 6,
    name: 'Kit Presente Rosas',
    brand: 'Carol Presentes',
    price: 'R$ 299,90',
    img: 'https://images.unsplash.com/photo-1588350350703-fddbfc5cfaf6?w=400&h=400&fit=crop&auto=format',
    tag: 'Oferta',
    liked: false,
  },
  {
    ...
    brand: 'Paco Rabanne',
    price: 'R$ 399,00',
    img: 'https://images.unsplash.com/photo-1541108564883-bec8126021f5?w=400&h=400&fit=crop&auto=format',
    tag: '',
    liked: false,
  },
  {
    ...
    brand: 'Carol Presentes',
    price: 'R$ 189,90',
    img: 'https://images.unsplash.com/photo-1571990306521-cf96e6858f2a?w=400&h=400&fit=crop&auto=format',
  ...
  },
  {
    ...
    brand: 'Carol Presentes',
    price: 'R$ 349,00',
    img: 'https://images.unsplash.com/photo-1759420319818-1a2c8684a584?w=400&h=400&fit=crop&auto=format',
    tag: 'Especial',
    liked: false,
  },
]
      ...
      <div style={{ backgroundColor: '#fff', padding: '20px 16px 0' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <div style={{ position: 'relative' }}>
            <div style={{ width: 80, height: 80, borderRadius: '50%', background: 'linear-gradient(135deg, #c9956c, #e8b4a0, #f7d4c8)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 32 }}>
              🌸
            </div>
        ...
        <div style={{ marginTop: 10 }}>
          ...
          <div style={{ fontSize: 13, color: '#5c4d47', lineHeight: 1.4, marginTop: 2 }}>
            ...
            📍 <span>Indaiatuba, SP</span> — Entrega para todo Brasil<br />
            💌 WhatsApp: (19) 19971455659<br />
          </div>
        </div>
      ...
      {tab === 'feed' && (
        <div>
          ...
          <div style={{ padding: '16px', marginTop: 12 }}>
            <h3 style={{ fontSize: 14, fontWeight: 700, color: '#2d2523', marginBottom: 12 }}>
              📸 Últimas publicações
            </h3>
            {PRODUCTS.slice(0, 5).map(product => (
              <article key={product.id} style={{ backgroundColor: '#fff', marginBottom: 12, borderBottom: '1px solid #f0e6df' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '12px 14px' }}>
                  <div style={{ width: 36, height: 36, borderRadius: '50%', background: 'linear-gradient(135deg, #c9956c, #f7d4c8)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, flexShrink: 0 }}>🌸</div>
                  <div>
                    <div style={{ fontWeight: 700, fontSize: 13, color: '#2d2523' }}>carol_presentes</div>
                    <div style={{ fontSize: 11, color: '#8c7b74' }}>{product.brand}</div>
                  </div>
                  <button style={{ marginLeft: 'auto', background: 'none', border: 'none', cursor: 'pointer' }}>
                    <span style={{ fontSize: 20, color: '#2d2523', letterSpacing: 1 }}>···</span>
                  </button>
                </div>
                ...
                <img
                  src={product.img}
                  alt={product.name}
                  style={{ width: '100%', aspectRatio: '1', objectFit: 'cover', backgroundColor: '#f7e8e0', display: 'block' }}
                />

                <div style={{ padding: '10px 14px' }}>
                  <div style={{ display: 'flex', gap: 16, marginBottom: 8 }}>
                    <button onClick={() => toggleLike(product.id)} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, fontSize: 22, transition: 'transform 0.15s', transform: liked[product.id] ? 'scale(1.2)' : 'scale(1)' }}>
                      {liked[product.id] ? '❤️' : '🤍'}
                    </button>
                  ...
                  <div style={{ fontSize: 13, fontWeight: 700, color: '#2d2523', marginBottom: 2 }}>
                    {liked[product.id] ? '1 curtida' : '0 curtidas'}
                  </div>
                  <div style={{ fontSize: 13, color: '#2d2523', lineHeight: 1.4 }}>
                    <span style={{ fontWeight: 700 }}>carol_presentes </span>
                    ✨ {product.name} — {product.brand} · {product.price}
                    {product.tag ? ` 🏷️ ${product.tag}` : ''} · Clique para saber mais! 🌸
                  </div>

                  <button
                    onClick={() => setSelected(product)}
                    style={{ marginTop: 10, width: '100%', backgroundColor: '#c9956c', color: '#fff', border: 'none', borderRadius: 8, padding: '9px 0', fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: "'Nunito', sans-serif" }}
                  >
                    Ver produto — {product.price}
                  </button>
                </div>
              </article>
            ))}
